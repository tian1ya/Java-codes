...
public class ThreadInheritance {
    public static void main(String[] args) {
        ...
        System.out.println("t1 thread group belong to main thread group: " + (mainThreadGroup.getName() == t1.getThreadGroup().getName()));
        System.out.println("t2 thread group belong to main thread group: " + (mainThreadGroup.getName() == t2.getThreadGroup().getName()));
